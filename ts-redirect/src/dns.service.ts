...
export function parseARecordFromWireV2(data: Uint8Array): string{
    ...
    // console.log(data[12]); // 4 ??
    // console.log(data[11]); 
    // console.log(data[10]); //  10 = ttl
    // console.log(data[9]);
    // console.log(data[8]);
    // console.log(data[7]);
    // console.log(data[6]); //  1 type = A
    // console.log(data[5]);
    // console.log(data[4]); // 1 class = IN  (internet)
    // console.log(data[3]);
    // console.log(data[2]);
    // console.log(data[1]);
